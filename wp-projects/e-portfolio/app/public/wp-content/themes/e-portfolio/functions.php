...
// Register Motivation quotes Post Type
function motivation_post_type() {

	$labels = array(
		'name'                  => _x( 'Motivation', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Motivation', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Motivation quotes', 'text_domain' ),
		'name_admin_bar'        => __( 'Motivation quotes', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Items', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Motivation', 'text_domain' ),
		'description'           => __( 'Motivation quotes', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
